...
class DebugVisualizer(jhk.Visualizer):
    ...
    def on_key_press(self, event):
        ...
        if key_name == 'SPACE':
            ...
            # Manually mark both hands as UWB-calibrated when entering draw/calibration
            # This forces the visualizer to consider both gloves calibrated after SPACE is pressed.
            try:
                self.left_hand.is_UWB_calibrated = True
                self.right_hand.is_UWB_calibrated = True
            except Exception:
                # If the attributes don't exist on the hand objects, silently continue.
                pass
