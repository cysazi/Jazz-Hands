...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max-area", type=float, default=mocap.DEFAULT_MAX_BLOB_AREA)
    parser.add_argument("--min-radius", type=float, default=mocap.DEFAULT_MIN_BLOB_RADIUS)
    parser.add_argument("--max-radius", type=float, default=mocap.DEFAULT_MAX_BLOB_RADIUS)
    parser.add_argument("--min-circularity", type=float, default=mocap.DEFAULT_MIN_BLOB_CIRCULARITY)
    parser.add_argument("--min-fill-ratio", type=float, default=mocap.DEFAULT_MIN_BLOB_FILL_RATIO)
    parser.add_argument("--max-aspect-ratio", type=float, default=mocap.DEFAULT_MAX_BLOB_ASPECT_RATIO)
